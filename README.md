...
<div align="justify"> Currently, this repository hosts:
  ...
  <br>(see "2022ConferenceAbstract.pdf")
  ...
  <br>(see "TechnicalSample1-DatasetIntegrationIntoGIS.pdf")
  ...
  <br>(see "TechnicalSample2-PointCloudProcedure.pdf")
  <br><h4> Code Sample - Simple Hapke Reflectance Model </h4>
  1 code sample I wrote to model bidirectional and hemispherical reflectance using Hapke theory.
  <br>(see "HapkeModelHemisphericalAndNormalAlbedo.ipynb") 
</div>
